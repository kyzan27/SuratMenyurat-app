<div class="block p-6 bg-white border border-gray-200 rounded-lg shadow  dark:border-gray-700 dark:hover:bg-gray-700">
    ...
    <div date-rangepicker class="flex items-center">
        ...
        <div>
            <x-button info label="Kirim Surat" wire:click="buka_modal_kirim_surat()" />
        </div>
    </div>
        ...
        <div class="relative overflow-x-auto shadow-md sm:rounded-lg scroll-my-px my-5">
            <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
                ...
                <tbody>
                    ...
                    @empty
                        <tr>
                            <th colspan="6">WATIR EWEUH NU NGIRIM SURAT</th>
                        </tr>
                    @endforelse
                </tbody>
            </table>
    ...
    <x-modal wire:model.defer="modal_kirim_surat">
        <x-card title="Kirim Surat">
